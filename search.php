...
<body>
    ...
    <form role="search" action="search.php" method="GET">
		<header class="navbar bg-white fixed-top flex-md-nowrap p-0 shadow mb-4">
			<div class="input-group input-group-sm m-1">
				...
				<button type="submit" class="btn btn-outline-primary border border-start-0 border-top border-bottom rounded-pill rounded-start"><img src="magnifying-glass-solid-2.svg" class="magnifying-glass-solid" alt="Pesquisar" title="Pesquisar"></button>
			</div>
		</header>
    </form>
    ...
    <?php
		...
		else {$resultsProvider = new DicionarioResultsProvider($con);$pageSize = 30;}
